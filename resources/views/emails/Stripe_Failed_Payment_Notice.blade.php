...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<div class="section" style="display: block; margin-bottom: 24px;">Your transaction with Nanny Parent Connection just failed. Please <a href="{{URL::to('UserDashboard')}}" style="color:#e58eb2;">update your payment details</a> and retry your purchase.</div>
