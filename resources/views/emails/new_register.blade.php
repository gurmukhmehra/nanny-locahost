...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<div class="section" style="display: block; margin-bottom: 24px;">{{$user_full_name}} ({{$user_login}})</div>
	<div class="section" style="display: block; margin-bottom: 24px;">Product Name: {{$productName}}</div>	
