                    ...
                    <div style="width: 100%;">                        			
                            <table role="presentation" style="text-align:center;" class="header_bg" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                    <tr>
										<a href="{{URL::to('/')}}">
                                        	<img src="https://nannyvuejs-app.devnannyparentconnection.com/public/assets/images/Nanny-Parent-Connection-Logo.png" style=margin-top:50px;>
										</a>
									</tr>
                                </tbody>
                            </table>                       
	...
	<div class="container">
		<div class="row" style="padding-top: 15px;">
			<div class="col-md-12 col-xs-12 col-sm-12">
				...
				<p>If you plan on using the <a href="https://nannyparentconnection.com/care-calendar/" style="color:#e58eb2;">CareCalendar</a> or <a href="https://nannyparentconnection.com/members/?members_search" style="color:#e58eb2;">Member Search</a> tools, please take a <a href="https://nannyparentconnection.com/help/#helpaddingcarecalendareventforfamilies-parents" style="color:#e58eb2;">few moments to fill out your online profile</a> before you start using those tools.</p>
				<p class="">Don't forget to check out our <a href="https://nannyparentconnection.com/last-minute-group-text/" style="color:#e58eb2;">Last Minute Care Text Service</a>. It's an incredibly helpful tool if you are in a bind and need child care ASAP.</p>
				<p class="">Also, please take a moment to <a href="https://nannyparentconnection.com/payrates/" style="color:#e58eb2;">check current pay rates</a> in our area or use our <a href="https://nannyparentconnection.com/pay-rate-worksheet/" style="color:#e58eb2;">Pay Rate Worksheet</a> to ensure you offer a competitive rate!</p>
				...
				<h2 style="text-align: center; text-transform: uppercase; padding: 1.1em; background-color: #53a3e8; margin-bottom: 26px;font-size:15px;margin-top:20px;"><span style="color: #ffffff;">I'M LOOKING FOR A LONG TERM, FULL OR PART TIME NANNY to work with...</span></h2>
				...
				<p class="" style="margin: 0px 0px; font-size: 17px;">
					<span style="color: #000000;">
						Looking for a care provider with a special skill or ability? Maybe you are looking for a nanny that lives close by? Check out our <a href="https://nannyparentconnection.com/members/?members_search" style="color:#e58eb2;">Member Search</a> tool! This tool allows you to search all member profiles for specific information such as languages spoken, preferred transportation method, location, etc.
					</span>
				</p>
				...
				<p class="" style="margin: 0px 0px; font-size: 17px;"><span style="color: #000000;">Schedule nannies and sitters offering child care on specific dates and times. Need a date night or time to get some shopping done? Post your need to the CareCalendar! With our <a href="https://nannyparentconnection.com/care-calendar/" style="color:#e58eb2;">CareCalendar</a>, you can search child care opportunities posted by other members or publish your own.
				</span></p>
				<h4 style="text-transform: uppercase; text-align: left;font-size: 14px;font-weight: bold;margin-top:20px;">post to our facebook communities</h4>
				...
				<h4 style="text-transform: uppercase; text-align: left;font-size: 14px;font-weight: bold;margin-top:20px;">search member profiles</h4>
				<p class="" style="margin: 0px 0px; font-size: 17px;"><span style="color: #000000;">Looking for a nanny or sitter that speaks Spanish? Check out our <a href="https://nannyparentconnection.com/members/?members_search" style="color:#e58eb2;">Member Search</a> tool! This tool allows you to search all member profiles for specific information such as languages spoken, preferred transportation method, location, etc.</span></p>
				...
				<p class="" style="margin: 0px 0px; font-size: 17px;"><span style="color: #000000;">If you urgently need child care in the next couple of hours or days, check out our <a href="https://nannyparentconnection.com/last-minute-group-text/" style="color:#e58eb2;">Last Minute Care Service</a>. Hundreds of nannies and sitters are signed up to receive text message alerts when parents need last minute child care.
				</span></p>
