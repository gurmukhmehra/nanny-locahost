                                            ...
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                ...
                                                <tr>
                                                        <td style="padding: 20px; font-family: Arial; mso-height-rule: exactly; line-height: 24px; color: #545454; font-size: 18px" class="body_text_color body_text_size">
                                                            <div id="receipt">
																<div class="section" style="display: block; margin-bottom: 24px; margin-left: 8px;">{{$name}}</div>
																<div class="section" style="display: block; margin-bottom: 24px; margin-left: 8px;">
															...
															<div class="section" style="display: block; margin-bottom: 24px; margin-left: 8px;">Laura Scoccolo</div>
															<div class="section" style="display: block; margin-bottom: 24px; margin-left: 8px;">Founder and "Chief Mommy"</div>
														</td>
                                                    </tr>
                                                </tbody>
                                            </table>
