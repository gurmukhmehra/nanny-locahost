                ...
                <td valign="top">
                    <div style="width: 100%; text-align: left;">
                        <div style="max-width: 900px; margin: auto;" class="email-container">			
                            <table role="presentation" style="border-radius: 5px;margin-top:30px;" class="body_bg" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#efefef" align="center">
                                <tbody>
                                    <tr>
                                        <td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding: 20px; font-family: sans-serif; mso-height-rule: exactly; line-height: 24px; color: #555555; font-size: 15px" class="body_text_color body_text_size">
                                                            <span style="font-weight: bold; font-size: 20px" class="welcome">Hi {{$user_first_name}}, Thanks for buy membership.</span>
                                                            <hr color="#F7F3F0">
