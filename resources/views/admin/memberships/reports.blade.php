                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- <button class="btn btn-danger downloadCSV" data-resultType=""><i class="fa fa-download"></i> Export as CSV</button> -->
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
<script src="{{ asset('admin/js/charts/plugins/apexcharts.min.js') }}"></script>
<script>
