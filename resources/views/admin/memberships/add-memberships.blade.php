                ...
                <div class="card-body"> 
                    ...
                    {{ Form::open(array('url' => 'superadmin/memberships/add' , 'autocomplete'=>'off', 'enctype' =>'multipart/form-data')) }}
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4">
                                <label style="color:#333;">Billing Type<sup class="text-danger">*</sup></label>
                                <select class="form-control billing_type" name="product_period_type">
                                    <option value="recurring" selected>Recurring</option>
                                    <option value="single">One-Time</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <span class="recurring_option">
                                    <label style="color:#333;">Product Type<sup class="text-danger">*</sup></label>
                                    <select class="form-control product_period" name="product_period">                                                     
                                ...
                                <span class="one_time_option" style="display:none;">
                                    <label style="color:#333;">Access</label>
                                    <select class="form-control product_period_limit" name="product_period_limit">
                                        <option value="delay">Expire</option>
                                        <!-- <option value="none">Lifetime</option>                                        
                                        <option value="fixed">Fixed Expire</option> -->
                                    </select>
                                    <div class="row">
                                        <label style="color:#333;width: 100%;margin-top: 10px;margin-left: 20px;">Expire After:</label>
                                        <div class="col-md-6">
                                            <input type="number" class="form-control" min="1" value="1" name="_mepr_expire_after">
                                        </div>
                                        <div class="col-md-6">
                                            <select class="form-control _mepr_expire_unit" name="_mepr_expire_unit">
