                                ...
                                <div class="col-md-3 user-img img-fluid text-center">
                                    <span v-if="careProvider.providersInfo.username!=username">                                        
                                        <router-link :to="{name: 'members-about', 
                                            ...
                                            <img v-if="careProvider.providersInfo.profileImage" :src="'../uploads/profileImage/'+careProvider.providersInfo.profileImage" alt="" class="rounded-circle" style="width: 100px;margin-top: 12px;">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <p class="mb-0" style="margin-top: 20px;">
                                                <span v-if="careProvider.providersInfo.memberType == 'care_provider_member'">
                                                    <img :src="'../uploads/Care-Provider-Icon.png'" title="Care Provider Member" style="cursor: pointer;margin-right: 20px;margin-bottom: 6px;"/>
                                                ...
                                                <span v-else-if="careProvider.providersInfo.memberType == 'family_parent_member'">
                                                    <img :src="'../uploads/Family_Parent-Icon.png'" title="Family/Parent Member" style="cursor: pointer;margin-right: 20px;margin-bottom: 6px;"/>
                                                ...
                                                <span v-else-if="careProvider.providersInfo.memberType == 'agency_member'">
                                                    <img :src="'../uploads/Agency-Icon.png'" title="Family/Parent Member" style="cursor: pointer;margin-right: 20px;margin-bottom: 6px;"/>
                                                </span>                               
                                                <span v-else ></span>
                                            </p>                     
                                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered" style="max-width:650px;">
                    <div class="modal-content">                               
                        <div class="modal-body"> 
                            <div class="row">
                                <div class="col-md-6">
                                    <img :src="'../assets/images/pexels-gustavo-fring.JPG'" style="height: 350px;width: 100%;"/>
                                </div>
