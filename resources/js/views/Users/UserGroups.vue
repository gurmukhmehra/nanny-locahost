                                        ...
                                        <div class="iq-card">
                                            <div class="iq-card-body text-center">
                                                <div class="group-icon">
                                                    <img v-if="!!groups.groupImage" :src="'../uploads/groupsImages/' + groups.groupImage" :alt="groups.groupSlug" class="rounded-circle img-fluid avatar-120">
                                                ...
                                                <!--div class="group-member mb-3">
                                                    <div class="iq-media-group">
                                                        <a href="" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle" src="http://127.0.0.1:8000/uploads/groupsImages/1951944234_p3.jpg" alt="">
                                                        </a>
                                                        <a href="" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle" src="http://127.0.0.1:8000/uploads/groupsImages/60190090_63.jpg" alt="">
                                                        </a>
                                                    </div>
                                                </div-->
