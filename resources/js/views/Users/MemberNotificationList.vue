                                    ...
                                    <li v-for="(notifications, index) in notificationLists" :key="notificationLists.id" class="d-flex align-items-center">
                                        <div class="user-img img-fluid">
                                            <a href="#" style="text-decoration:none;">
                                                <img v-if="!!notifications.SenderDetails.profileImage" :src="'../uploads/profileImage/' + notifications.SenderDetails.profileImage" alt="story-img" class="rounded-circle avatar-40">
