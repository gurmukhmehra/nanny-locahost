<template>
    <div class="iq-card-body profile-page p-0 mt-3">
        <div class="profile-header">
            <div v-if="!!ProfileCover" class="cover-container-header" :style="{'background-image': 'url(' + '../uploads/coverImages/'+id +'/cover-image/' + ProfileCover + ')'}">
            </div>
            ...
            <div class="user-detail text-center mb-3">
                <div class="profile-img">
                    <img v-if="!!profileImage" :src="'../uploads/profileImage/' + profileImage" alt="profile-img" class="avatar-130 img-fluid" />
            ...
            <div class="profile-info p-4 d-flex align-items-center justify-content-between position-relative">
                ...
                <div class="social-info">
                    <ul class="social-data-block d-flex align-items-center list-inline" style="list-style-type: none;">
                        ...
                        <li v-if="memberType === 'family_parent_member'">
                            <span v-if="UserBioDetail.numnerOfchild != ''" class="fmaily_count_child" title="Number of children needs care for aa">
                                {{UserBioDetail.numnerOfchild }}</span>
                            <span v-else class="fmaily_count_child" title="Number of children needs care for bb">
                                0</span>
                        </li>
                        ...
                        <li v-if="memberType === 'care_provider_member'">
                            <span class="provider_count_child" title="Number of children will provide care for at one time aa">{{UserBioDetail.providerCareOneTime }}</span>
                        </li>
