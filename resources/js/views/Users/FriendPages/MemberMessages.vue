                        ...
                        <div class="iq-card">
                            <div class="iq-card-body profile-page p-0 mt-3">
                                <div class="profile-header">
                                    <div v-if="!!membersDetais.ProfileCover" class="cover-container-header" :style="{'background-image': 'url(' + '../uploads/coverImages/'+membersDetais.id +'/cover-image/' + membersDetais.ProfileCover + ')'}">
                                    </div>
                                    ...
                                    <div class="user-detail text-center mb-3">
                                        <div class="profile-img">
                                            <img v-if="!!membersDetais.profileImage" :src="'../uploads/profileImage/' + membersDetais.profileImage" alt="profile-img" class="avatar-130 img-fluid" />
                                        ...
                                        <div class="social-info" v-if="friendRequestStatus>0">
                                            ...
                                            <ul class="social-data-block d-flex align-items-center list-inline" style="list-style-type: none;">
                                                <li v-if="membersDetais.memberType === 'family_parent_member'">
                                                    <img :src="'../uploads/Family_Parent-Icon.png'" title="Family/Parent Member" class="member_icons"/>                            
                                                </li>
                                                <li v-if="membersDetais.memberType === 'family_parent_member'">
                                                ...
                                                <li v-if="membersDetais.memberType === 'care_provider_member'">
                                                    <img :src="'../uploads/Care-Provider-Icon.png'" title="Care Provider Member" class="member_icons"/>
                                                </li>
                                                <li v-if="membersDetais.memberType === 'care_provider_member'">
                                                ...
                                                <li v-if="membersDetais.memberType === 'agency_member'">
                                                    <img :src="'../uploads/Agency-Icon.png'" title="Family/Parent Member" class="member_icons"/>
                                                </li>
                                ...
                                <header class="d-flex justify-content-between align-items-center bg-white pt-3 pl-3 pr-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="avatar chat-user-profile m-0 mr-3">
                                            <img v-if="!!membersDetais.profileImage" :src="'../uploads/profileImage/' + membersDetais.profileImage" alt="profile-img" class="avatar-50" />
                            ...
                            <div v-for="(FriendsChatMsg,index) in MembersThreadsMessages" :key="FriendsChatMsg.id" :index="index" class="chat-content scroller" style="background-color:rgba(215, 213, 212, 0.8);padding-top: 0px;padding-bottom: 0px;">
                                <div class="chat">
                                    <p v-if="FriendsChatMsg.sender_id == id">
                                        <div class="chat-user">
                                            <a class="avatar m-0">                                                                    
                                                <img v-if="!!profileImage" :src="'/uploads/profileImage/' + profileImage" alt="avatar" class="avatar-35" style="width:90px;float: left;">
                                    ...
                                    <p v-if="FriendsChatMsg.MessageUsersDetails.id != id" style="clear: both;padding-top: 20px;">
                                        <div class="chat chat-left">
                                            <div class="chat-user">
                                                <a class="avatar m-0">
                                                    <img v-if="!!FriendsChatMsg.MessageUsersDetails.profileImage" :src="'/uploads/profileImage/' + FriendsChatMsg.MessageUsersDetails.profileImage" alt="avatar" class="avatar-35" style="width:90px;float: left;">
                                                    <img v-else src="https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652__340.png" alt="avatar" class="avatar-35" style="width:90px;float: left;">
