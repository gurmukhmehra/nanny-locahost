                        ...
                        <div class="row">
                            <div class="col-lg-10 d-flex align-items-center justify-content-between mb-3">
                                <div class="group-info d-flex align-items-center">
                                    <div class="mr-3">
                                        <img class="rounded-circle img-fluid avatar-100" v-if="!!GroupDetail.groupImage" :src="'../uploads/groupsImages/' + GroupDetail.groupImage" :alt="GroupDetail.groupSlug">
                        ...
                        <div id="post-modal-data" class="iq-card">
                            ...
                            <div class="iq-card-body" data-toggle="modal" data-target="#post-modal">
                                <div class="d-flex align-items-center">
                                    <div class="user-img">
                                        <img v-if="!!profileImage" :src="'../uploads/profileImage/' + profileImage" class="avatar-60 rounded-circle img-fluid">
                                ...
                                <div v-for="(GroupPost,index) in GroupPostsList" :key="GroupPost.id" :index="index" class="post-item">
                                        ...
                                        <div class="user-post-data pt-3 pr-3 pb-3 pl-0 mt-4" v-if="groupUsrDetail.id == GroupPost.usersID">
                                            <div class="d-flex flex-wrap">
                                                <div class="media-support-user-img mr-3">
                                                    <img class="rounded-circle img-fluid" v-if="!!groupUsrDetail.profileImage" :src="'../uploads/profileImage/' + groupUsrDetail.profileImage" alt="avatar">
                                    ...
                                    <div class="user-post">
                                        ...
                                        <a v-if="!!GroupPost.postMedia" href="javascript:void();">
                                            <img :src="'../assets/images/52.jpg'" alt="post-image" class="img-fluid w-100" />
                                        </a>
                                    </div>
                                    <div class="comment-area mt-3">
                                        ...
                                        <div class="d-flex align-items-center mt-0">                                        
                                            <div class="user-img mr-2">
                                                <img v-if="!!profileImage" :src="'../uploads/profileImage/' + profileImage" class="avatar-60 rounded-circle img-fluid" style="width:20px;height:20px;">
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h6 class="iq-card-title">Groups List</h6>
                                </div>
                            </div>
                            <hr style="margin-bottom: 0px;margin-top: 0;height: 0px;">
                            <div class="iq-card-body">
                                <ul class="list-inline p-0 m-0">
                                    <li class="mb-3 align-items-center" v-for="(groups,index) in groupsList" :key="groups.id" :index="index">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="avatar-40 rounded-circle bg-grey text-center mr-3" style="width:60px;height:60px;">
                                                    <img v-if="!!groups.groupImage" :src="'../uploads/groupsImages/' + groups.groupImage" :alt="groups.groupSlug" class="rounded-circle img-fluid">
                                                    <img v-else src="https://templates.iqonic.design/socialv/bs5/html/dist/assets/images/page-img/gi-1.jpg" alt="profile-img" class="rounded-circle img-fluid">
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                <h6 class="mb-0 w-100">
...
export default { 
    ...
    methods: {
        ...
        getAllGroupPosts(){
            axios.get(`/api/groupInfo/${this.groupID}`).then((response) => {  
            console.log('posts ',response.data.groupPosts);         
            this.GroupDetail = response.data.groupDetails;
            this.totalGroupMember = response.data.groupMemberSum;
            this.CheckGroupJoin = response.data.userJoinGroup;
            this.GroupPostsList = response.data.groupPosts;
