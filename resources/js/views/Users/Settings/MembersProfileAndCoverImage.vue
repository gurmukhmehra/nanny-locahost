                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 pl-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">                                                    
                                                <div class="form-group  mt-3">
                                                    <label for="profilePic" style="font-weight:600;width:100%;">Profile Image : <small class="text-danger">Note: Profile image min width : 240 , min height : 300</small></label>
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-md-10">                                                    
                                                <div class="form-group  mt-3">
                                                    <label for="profileCoverPic" style="font-weight:600;width:100%;">Profile Cover Image : <small class="text-danger">Note: Cover image 1300px wide, and 225px tall.</small></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2" v-if="this.CoverImageSrc">
                                                    <div class="col-md-1">
                                                        <button class="btn btn-dark" v-if="this.CoverImageSrc" @click="cropCoverImage">Crop</button>
                                                    </div>
                                                    <div class="col-md-1 mt-2">
                                                        <button class="custom_yellow_btn" v-if="this.CoverImageSrc" @click="ProfileCoverImage" >Upload</button>
                                                    </div>                                                    
                                                </div>
                                            </div>
                                        </div>
