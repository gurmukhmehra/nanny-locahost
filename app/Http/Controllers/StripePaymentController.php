...
class StripePaymentController extends Controller
{
    ...
    {        
        /****************** Live Webhook *************************/  
            ...
            //     'sk_test_51LSEpOHHk9pJpDONLh1lgKUnvYXiGNbJpsjdT012Spp6Mq7UOvgzLT2yRu968nYCNkPoEvYO2yZhIV7PQ4eMD90W00COIZz6Km'
            // );        
            // $endpoint_secret = 'whsec_rYzhR0SyTyNjQJIvhey94kpJ3aIUb185';
        /********************* Live Webhook **********************/
        //$endpoint_secret = 'whsec_629a19ee0154738e487339c4d65d31f17d84c091c70498367cfce98299d2460d';
        $patmentGateway = PaymentGateway::where('id',1)->first();
        ...
        case 'invoice.payment_succeeded':
            ...
            $findUserInfo = User::where('email',$user->email)->first();
            ...
            /******************** Email To Member ******************************/
                ...
                //     //$message->to($data['email']);
                //     $message->bcc('sudhirkundal007@gmail.com'); 
                //     $message->to('sudhirkundal007@gmail.com');
                // });                        
    ...
    public function successURL($value)
    {
        dd($value);  
        return response()->json([
